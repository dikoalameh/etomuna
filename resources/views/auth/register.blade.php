...
<x-guest-layout>
    <!-- nilagyan ko nalang para mahide ung 2nd part for co-investigator -->
    <style>
        .step {
            display: none;
        }
    ...
    <form method="POST" action="{{ route('register') }}" id="studentForm">
        ...
        <div id="step1" class="step active">
            ...
            <div class="mt-3">
                ...
                <x-input-label id="inputLabel" for="pi_program" :value="__('Select Program')" />
                <x-combo-box id="pi_program" name="pi_program"
                    class="block border-gray mt-1 w-full text-[14px] max-sm:text-[13px] h-[35px] leading-[15px]" />
            ...
            <div class="flex items-center justify-end mt-4">
                ...
                <button type="button" onclick="nextStep()" class="ml-2 max-sm:text-sm bg-secondary hover:bg-primary text-primary hover:text-secondary rounded-lg px-4 py-2 uppercase tracking-widest duration-200">
                    NEXT
                </button>
            </div>
        </div>
        <div id="step2" class="step">
            ...
            <div id="co-wrapper">
                ...
                <x-text-input id="Co_Investigators" class="block mt-1 w-full text-[14px] max-sm:text-[13px] h-[35px]"
                    type="text" name="Co_Investigators" :value="old('Co_Investigators')" autocomplete="Co_Investigators"
            ...
            <div class="flex items-center justify-end mt-4">
                ...
                <button type="button" onclick="prevStep()" class="ml-2 max-sm:text-sm bg-secondary hover:bg-primary text-primary hover:text-secondary rounded-lg px-4 py-2 uppercase tracking-widest duration-200">
                    Back
                </button>
...
<script>
    ...
    // function to proceed to 2nd part of registration
    function nextStep() {
    ...
    // function to go back to the 1st part of registration
    function prevStep() {
        document.getElementById("step" + currentStep).classList.remove("active");
        currentStep--;
        document.getElementById("step" + currentStep).classList.add("active");
